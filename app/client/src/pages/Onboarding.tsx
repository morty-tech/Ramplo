...
export default function Onboarding() {
  ...
  if (showOnboardingComplete) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-aura-600 to-eclipse-800 relative isolate overflow-hidden">
        ...
        <div className="flex-grow flex flex-col justify-center">
          ...
          <div className="sm:mx-auto sm:w-full sm:max-w-2xl mb-6">
            ...
            <div className="mb-4">
              ...
              <Progress value={progress} className="h-2 bg-white/20 [&>div]:bg-frost-600" />
            </div>
          </div>
