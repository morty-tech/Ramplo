    ...
    <div className="p-6 mx-4 md:mx-8 relative isolate min-h-screen">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%-10rem)] aspect-[1155/678] w-[48rem] -translate-x-1/2 rotate-[15deg] bg-gradient-to-tr from-[#22c55e] to-[#16a34a] opacity-8 sm:left-[calc(50%-15rem)] sm:w-[60rem]"
        />
      </div>
      ...
      >
        <div
          ...
          className="relative aspect-square w-[32rem] bg-gradient-to-bl from-[#22c55e] to-[#15803d] opacity-12 sm:w-[40rem]"
        />
      </div>
      ...
      >
        <div
          ...
          className="relative aspect-square w-[28rem] bg-gradient-to-br from-[#16a34a] to-[#15803d] opacity-8 sm:w-[35rem]"
        />
      </div>
      
      {/* Bottom subtle glow for engagement */}
      <div
        aria-hidden="true"
