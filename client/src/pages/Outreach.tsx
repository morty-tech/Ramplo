            ...
            <div className="w-1/2">
              <Listbox as="div" value={selectedTemplate} onChange={(template) => setSelectedTemplateId(template?.id || '')}>
                ...
                <div className="relative">
                  <ListboxButton className="grid w-full cursor-default grid-cols-1 rounded-md bg-aura-100 py-1.5 pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-aura-600 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-aura-400 sm:text-sm/6">
                  ...
                  <ListboxOptions
                    transition
                    className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-aura-100 py-1 text-base shadow-lg outline-1 outline-black/5 data-leave:transition data-leave:duration-100 data-leave:ease-in data-closed:data-leave:opacity-0 sm:text-sm"
                  >
            ...
            {selectedTemplate && (
              <div className="flex flex-col items-start">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-sm bg-gradient-to-r from-aura-600 to-electric-600 text-white hover:from-aura-500 hover:to-electric-500 rounded-md transition-all duration-200 shadow-sm hover:shadow-md"
                >
